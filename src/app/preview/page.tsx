...
const MOCK_ATTENTION: AttentionResponse = {
  groups: [
    ...
    },
    {
      ...
      companies: [
        { id: "106", name: "Bergen Outdoor Co", detail: "28", ownerId: "1", mrr: "\u20ac10 000", currency: "EUR", previousCategory: "45", categoryChangedAt: "2026-03-18T10:00:00.000Z", enteredGroupAt: "2026-03-18T10:00:00.000Z", healthScore: "28", volume12m: 310000, volume3m: 50000, volume6m: 145000, payStatus: "Active", revenue: 18600 },
        { id: "107", name: "Helsinki Tasting Club", detail: "42", ownerId: "2", mrr: "\u20ac30 000", currency: "EUR", previousCategory: "68", categoryChangedAt: "2026-03-10T14:00:00.000Z", enteredGroupAt: "2026-03-10T14:00:00.000Z", healthScore: "42", volume12m: 89000, volume3m: 22000, volume6m: 44000, payStatus: "Active", revenue: 5340 },
      ],
    },
    {
      signal: "gone_quiet",
