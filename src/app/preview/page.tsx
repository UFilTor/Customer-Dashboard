  ...
  groups: [
    {
      ...
      companies: [
        { id: "101", name: "Nordic Kayak Tours", detail: "Nordic Kayak - Pro", ownerId: "1", mrr: "\u20ac25 000", currency: "EUR", daysOverdue: 3, enteredGroupAt: undefined, healthScore: "38", volume12m: 186000, volume3m: 52000, volume6m: 120000, payStatus: "Active" },
        { id: "102", name: "Copenhagen Food Walks", detail: "Food Walks - Starter", ownerId: "2", mrr: "\u20ac8 000", currency: "EUR", daysOverdue: 14, enteredGroupAt: undefined, healthScore: "52", volume12m: 42000, volume3m: 8000, volume6m: 22000, payStatus: undefined },
      ],
    },
    {
      ...
      label: "Overdue Tasks",
      companies: [
        { id: "103", name: "Stockholm Adventures", detail: "Send onboarding materials", ownerId: "1", daysOverdue: 2, mrr: "\u20ac5 000", currency: "EUR", enteredGroupAt: daysAgoISO(2), healthScore: "85", volume12m: 95000, volume3m: 28000, volume6m: 50000, payStatus: "Active" },
        { id: "104", name: "Malmo Workshops", detail: "Schedule Q1 review", ownerId: "2", daysOverdue: 8, mrr: "\u20ac3 500", currency: "EUR", enteredGroupAt: daysAgoISO(8), healthScore: "61", volume12m: 31000, volume3m: 6000, volume6m: 16000, payStatus: "Active" },
        { id: "105", name: "Gothenburg Experiences", detail: "Follow up on payment setup", ownerId: "1", daysOverdue: 15, mrr: "\u20ac15 000", currency: "EUR", enteredGroupAt: daysAgoISO(15), healthScore: "45", volume12m: 220000, volume3m: 40000, volume6m: 110000, payStatus: undefined },
      ],
    },
    {
      signal: "health_score",
      ...
      companies: [
        { id: "106", name: "Bergen Outdoor Co", detail: "28", ownerId: "1", mrr: "\u20ac10 000", currency: "EUR", previousCategory: "45", categoryChangedAt: "2026-03-18T10:00:00.000Z", enteredGroupAt: "2026-03-18T10:00:00.000Z", healthScore: "28", volume12m: 310000, volume3m: 50000, volume6m: 145000, payStatus: "Active" },
        { id: "107", name: "Helsinki Tasting Club", detail: "42", ownerId: "2", mrr: "\u20ac30 000", currency: "EUR", previousCategory: "68", categoryChangedAt: "2026-03-10T14:00:00.000Z", enteredGroupAt: "2026-03-10T14:00:00.000Z", healthScore: "42", volume12m: 89000, volume3m: 22000, volume6m: 44000, payStatus: "Active" },
      ],
    },
    {
      signal: "gone_quiet",
      label: "Gone Quiet",
      companies: [
        { id: "108", name: "Oslo Creative Labs", detail: "Last contacted 62 days ago", ownerId: "2", daysSilent: 62, mrr: "\u20ac15 000", currency: "EUR", enteredGroupAt: daysAgoISO(62), healthScore: "78", volume12m: 215000, volume3m: 62000, volume6m: 108000, payStatus: "Active" },
        { id: "109", name: "Aarhus Adventure Park", detail: "Last contacted 51 days ago", ownerId: "1", daysSilent: 51, mrr: "\u20ac12 000", currency: "EUR", enteredGroupAt: daysAgoISO(51), healthScore: "48", volume12m: 56000, volume3m: 10000, volume6m: 34000, payStatus: undefined },
        { id: "110", name: "Tampere Escape Rooms", detail: "Last contacted 48 days ago", ownerId: "1", daysSilent: 48, mrr: "\u20ac9 000", currency: "EUR", enteredGroupAt: daysAgoISO(48), healthScore: "71", volume12m: 130000, volume3m: 35000, volume6m: 67000, payStatus: "Active" },
      ],
    },
  ],
