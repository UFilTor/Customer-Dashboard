    ...
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-3">
        ...
        <div className="border border-[#EDEDEA] rounded-[var(--border-radius)] p-3 flex flex-col items-center">
          ...
          <div className="grid grid-cols-4 gap-2 flex-1 content-center w-full">
              ...
              return (
                <div key={key} className="text-center">
                  <div className="relative w-11 h-11 mx-auto">
                    ...
                    <span className="absolute inset-0 flex items-center justify-center text-[10px] font-bold" style={{ color: textColor }}>{pct}</span>
                  </div>
        ...
        {/* Card 2: Volume Trend */}
        <div className="border border-[#EDEDEA] rounded-[var(--border-radius)] p-3 flex flex-col items-center">
          <div className="relative w-full text-center text-[10px] text-[var(--green-100)] uppercase tracking-wide mb-2">
            Volume
            {growthPct !== null && (
              <span className={`absolute right-0 font-semibold ${growthPct > 0 ? "text-[#065F46]" : "text-[var(--rust)]"}`}>
          ...
          {company.understory_pay_unwilling === "true" ? (
            ...
            <div className="flex flex-col gap-2.5 flex-1 justify-center">
              {[
                ...
                let currentIdx = 0;
                for (let j = arr.length - 1; j >= 0; j--) { if (arr[j].active) { currentIdx = j; break; } }
